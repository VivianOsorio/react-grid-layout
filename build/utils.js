...
function childrenEqual(a /*: ReactChildren*/, b /*: ReactChildren*/) /*: boolean*/{
  return (0, _fastEquals.deepEqual)(
  // React.Children.map(a, c => c?.key),
  // React.Children.map(b, c => c?.key)

  _react.default.Children.map(a, c => c ? c.key : undefined), _react.default.Children.map(b, c => c ? c.key : undefined)) && (0, _fastEquals.deepEqual)(_react.default.Children.map(a, c => c && c.props && c.props["data-grid"]), _react.default.Children.map(b, c => c && c.props && c.props["data-grid"]))
...
function synchronizeLayoutWithChildren(initialLayout /*: Layout*/, children /*: ReactChildren*/, cols /*: number*/, compactType /*: CompactType*/, allowOverlap /*: ?boolean*/) /*: Layout*/{
  ...
  _react.default.Children.forEach(children, (child /*: ReactElement<any>*/) => {
    ...
    if (!child || child.key == null) return;
